                ...
                <table id='board' className='tableboard'>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td className='tabledw'>{this.cell(this.props.board, 'e5')}</td>
                            ...
                            <td className='tabledw'>{this.cell(this.props.board, 'e11')}</td>
                        ...
                        <tr>
                            ...
                            <td className='tabledw'>{this.cell(this.props.board, 'k5')}</td>
                            ...
                            <td className='tabledw'>{this.cell(this.props.board, 'k11')}</td>
